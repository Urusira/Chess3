/**
  @file Position.cs
  @brief Класс позиции, содержит координаты X,Y, используется в качестве ключа
  @author Листопад В.
\par Содержит класс:
  @ref Position
*/
...
namespace GameLogic
{
    public class Position
    {
        ...
        */
        ...
        /** Получаем хэш-код, чтобы класс позиции можно было использовать в качестве ключа в
            словаре, весьма удобно. Получать его позволяет встроенная функция в вижуале,
            вызывается сочетанием клавиш "ctrl + ." и выбором соответствующего пункта
        */
        ...
        /** Перегрузка оператора +, позволяет добавлять к текущей позиции по
            вертикали и горизонтали разницу, между ней и новой позицией
        */
