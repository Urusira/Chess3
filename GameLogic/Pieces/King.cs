...
namespace GameLogic
{
    public class King : Piece
    {
        ...
        public override PieceType Type => PieceType.King; ///< Определяем тип фигуры из списка
        public override Player Color { get; }             ///< Установка цвета фигуры
        ...
        private static readonly Direction[] dirs = new Direction[]
        {
            ...
            Direction.SouthWest,
            Direction.SouthEast
        };  ///< Список направлений, по которым ходит фигура
